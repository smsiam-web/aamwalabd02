...
const AllOrder = () => {
  ...
  // Dismiss the notification after a specific delay (e.g., 5 seconds)
  setTimeout(() => {
    notifications.hide(); // Assuming `notifications.hide()` is the correct method to dismiss the notification
